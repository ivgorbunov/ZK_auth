...
public:
    ...
    // quotient, remainder
    static std::pair<BigInteger, BigInteger> divide(const BigInteger&, const BigInteger&);
...
private:
    ...
    static std::strong_ordering compare_digit_groups(const std::vector<long long>&, const std::vector<long long>&);
    ...
    static std::pair<BigInteger, BigInteger> divide32(const BigInteger&, const BigInteger&, size_t);
    static std::pair<BigInteger, BigInteger> divide21(const BigInteger&, const BigInteger&, size_t);
